import './UnauthorizedErrorHandler.css'
...
export class UnauthorizedErrorHandler implements IComponentErrorHandler<ReactIncomingEvent> {
  private readonly logger: ILogger

  /**
   * Create an UnauthorizedErrorHandler.
   *
   ...
   */
  render ({ data, statusCode }: RenderErrorContext<UnauthorizedError>) {
    return (
